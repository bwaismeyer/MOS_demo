# MOS Demo: Simulating Wine Qaulity Assessments
Brian Waismeyer  
June 5, 2015  
...
[via AWS](http://ec2-52-26-165-185.us-west-2.compute.amazonaws.com:3939/MOS_demo/).
...
MOS instance - are available at the [MOS framework GitHub repository](https://github.com/bwaismeyer/MOS_framework).

To create an MOS instance, you need four things:

1. a dataset with at least one multinomial outcome
2. a multinomial model formula for that dataset
3. the [MOS framework files](https://github.com/bwaismeyer/MOS_framework)
3. the `MOS_config.R` file tailored to the model, data, and your audience (a 
rough, unconfigured version of this file comes with the MOS framework files)
...
To this end, I chose the [Wine Quality Dataset](http://archive.ics.uci.edu/ml/datasets/Wine+Quality)
...
Check out the demo [`MOS_config.R`](https://github.com/bwaismeyer/MOS_demo/blob/master/MOS_config.R) 
